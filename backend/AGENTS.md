# ⚠️ DEPRECATED / ESKİ REHBER

Bu dosya eski tek parça dokümantasyona aittir ve yedek amacıyla tutulmaktadır. 
Güncel ve modüler dikey rehberler için lütfen kök dizindeki **[AGENTS.md](file:///C:/Denemeler/RAG borsa sistemi deneme/AGENTS.md)** dosyasını ve **`agent/`** klasörünü inceleyin.
